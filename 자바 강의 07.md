...
>이 날은 전역변수에 대해 분명 배웠다... 저걸 필드라고 부른다는 사실도 분명히 배웠었다... 전역변수는 필드라고 부른다. 중요하니까 한번 더 말한다. 전역변수는 필드라고 부른다.   
>나는 이 사실을 6월 15일이 되어 문제를 보고나서야 알게 되었다. 문제를 보는데 '필드가 대체 뭐지?'라고 생각하고 있었다.   
>나는 분명 배웠지만 알지 못했던 것 같다.   
>랜덤에 대해 전날 배웠지만 실사용은 이 때 했던 것으로 기억난다. 2자릿수 덧셈 문제를 만들고 맞추면 점수를 주고 틀리면 모아서 해답까지 제공해줘야하는 코딩을 과제로 받았다.   
>나는 카운트라는 것을 이 날 제대로 알게 되었다. 2시간을 고민했지만 답이 나오지 않아 채호에게 도움을 요청했었다. 요청하는 순간 카운트를 올리면 된다는 사실을 알게 되었고, 해답을 얻게 되었다.   
>이 날도 나는 채호에게 똑같은 문제를 다른 방식으로 푸는 방법을 받았다. 난 !=를 이렇게도 쓸 수 있다는 사실을 처음으로 알게 되었다.
